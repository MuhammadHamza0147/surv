                                        ...
                                        <div class="container">
                                            <div class="row new-development-row" data-aios-staggered-parent="true"
                                                ...
                                                <div class="col-md-6 remove-margin-right"
                                                    ...
                                                    <div class="new-development-section">
                                                        ...
                                                        <div class="new-development-content">
                                                            <p>
                                                                Our services are a combined fusion of
                                                                Surveillance methods & Private
                                                                Investigations which are available to all
                                                                our International clients and business’s.
                                                                <br /><br />
                                                                We pride ourself on the foundations our
                                                                relationships are built and our global
                                                                networking. Our positive reputation is
                                                                promoted by our clients both new and old
                                                                by word of mouth on an International
                                                ...
                                                <div class="col-md-6" data-aios-staggered-child="true"
                                                    ...
                                                    style="padding: 0">
                                                    <div class="new-development-links-section international_network_bg">
                                                        <div class="new-development-links-title">
                                                            GLOBAL<b>NETWORK</b><i class="title-line2"></i>
                                                        </div>
                                            ...
                                            <div class="new-development-about-section" id="new-development-about-us"
                                                ...
                                                <div class="row new-development-row">
                                                    <div class="col-md-6" data-aios-staggered-child="true"
                                                        ...
                                                        <div class="new-development-about-text">
                                                            ...
                                                            <div class="new-development-about-content">
                                                                <p>
                                                                    We work hard for you, no matter the
                                                                    situation, discreetly and privately our
                                                                    dedication is un-questionable along with
                                                                    our results.<br />
                                                                    If you have a suspicion of a travelling
                                                                    partner or employee to the UK, or need a
                                                                    business service investigating then
                                                                    choosing the right team is going to be
                                                                    important. <br /><br />
                                                                    Surveillance UK, we are the right
                                                                    choice.<br /><br />
                                                                    From our All Services page you can view
                                                                    the services we offer and all are
                                                                    available to our International clients.
                                                                    <br /><br />
                                                                    Use our Contact Us form below to reach
                                                                    out let us put a plan of action in place
                                                                    for you.
                                                                </p>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="col-md-6" data-aios-staggered-child="true"
                                                        ...
                                                        <div class="new-development-about-photo2">
                                                            <img src="{{asset('assets/images/International-Choice.webp')}}"
                                        ...
                                        <div class="container">
                                            <div class="new-development-services-section" id="new-development-services"
                                                ...
                                                <div class="container1">
                                                    <a href="{{route('services.all')}}" data-title="Our Services">
                                                        <img src="{{asset('assets/images/Tracing-Services.webp')}}"
                                                            ...
                                                            data-aios-animation-delay="0s" />
                                                        <div class="textOnimage" style="background-color: gray; padding: 15px; color: white;">
                                                            OUR SERVICES
                                                        </div>
                                                    </a>
                                                </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6" data-aios-staggered-child="true"
                                                            ...
                                                            <div class="new-development-past-experience-photo">
                                                                <img src="{{asset('assets/images/International-Overview.webp')}}"
                                                        ...
                                                        <div class="col-md-6" data-aios-staggered-child="true"
                                                            ...
                                                            <div class="new-development-past-experience-text">
                                                                ...
                                                                <ul>
                                                                    ...
                                                                    <li>
                                                                        <strong class="overview_symbol">➢</strong>
                                                                        <span> All Services Provided</span>
                                                                    </li>
                                                                    <li>
                                                                        <strong class="overview_symbol">➢</strong>
                                                                        <span> Fully UK Regulated</span>
                                                                    </li>
                                                                    <li>
                                                                        <strong class="overview_symbol">➢</strong>
                                                                        <span>
